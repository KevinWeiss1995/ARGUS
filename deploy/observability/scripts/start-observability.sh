...
echo ""
echo "Manage nodes:"
echo "  Add:      argus-manage-targets add <host>"
echo "  Remove:   argus-manage-targets remove <host>"
echo "  Scan:     argus-discover --subnet <CIDR> --start"
echo "  Verify:   argus-manage-targets verify"
echo "  Status:   argus-status --all"
echo "  TUI:      argus-tui --attach <host>"
echo ""
